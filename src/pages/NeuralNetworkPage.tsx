    ...
    <PageTransition>
      <div className="h-screen pt-24 pb-4 bg-black relative overflow-hidden flex flex-col">
        ...
        <motion.div
          ...
          className="relative z-10 px-6 md:px-12 py-6 flex flex-col md:flex-row items-center justify-between pointer-events-none"
        >
        ...
        <motion.div
          ...
          className="flex-1 relative mx-4 md:mx-8 mb-2 rounded-2xl overflow-hidden border border-white/5 bg-gradient-to-b from-white/5 to-black/40 backdrop-blur-sm shadow-2xl"
        >
          <NeuralNetwork3D />
